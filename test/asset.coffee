...
describe 'an asset', ->
    app = null
    origUrl = '/blank.txt'
    hashedUrl = 'http://localhost:7076/blank-8ac5a0913aa77cb8570e8f2b96e0a1e7.txt'
    absoluteUrl = 'http://localhost:7076/blank.txt'
    ...
    it 'should work with no hash', (done) ->
        ...
        app.use asset = new rack.Asset
            ...
            contents: 'asset-rack'
        app.listen 7076, ->
            easyrequest absoluteUrl, (error, response, body) ->
    ...
    it 'should work with hash', (done) ->
        ...
        app.use new rack.Asset
            ...
            contents: 'asset-rack'
        app.listen 7076, ->
            easyrequest hashedUrl, (error, response, body) ->
                response.headers['content-type'].should.equal 'text/plain'
